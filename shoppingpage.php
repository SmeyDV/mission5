...
<head>
  ...
  <style>
    ...
    .pagination-container {
      margin-top: 30px;
      /* Add desired top margin */
      margin-bottom: 30px;
      /* Add desired bottom margin */
    }
  </style>
</head>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container">
      <a class="navbar-brand font-custom" href="shoppingpage.php">Products</a>
      <button
      ...
      <div class="col-md-2 col-12">
        <div class="filter-bar">
          <div class="filter-section">
            ...
            <label><input type="checkbox" class="filter" data-filter="jewelry" />
              Jewelry</label><br />
            <label><input type="checkbox" class="filter" data-filter="figurine" />
              Figurine</label><br />
            <label><input type="checkbox" class="filter" data-filter="silk" />
              Silk</label><br />
            <label><input
                type="checkbox"
                class="filter"
                data-filter="wooden carving" />
              Wooden Carving</label><br />
            <label><input type="checkbox" class="filter" data-filter="ceramic" />
              Ceramic</label>
          </div>
          <div class="filter-section">
            <h5>Price</h5>
            <label><input type="checkbox" class="filter" data-filter="price-1" />
              $30 - $50</label><br />
            <label><input type="checkbox" class="filter" data-filter="price-2" />
              $50 - $100</label><br />
            <label><input type="checkbox" class="filter" data-filter="price-3" />
              $100 - $300</label><br />
            <label><input type="checkbox" class="filter" data-filter="price-4" />
              $300+</label>
          </div>
        </div>
      </div>
